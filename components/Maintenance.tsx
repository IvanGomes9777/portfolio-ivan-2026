...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      "Inhaltliche Pflege — bis zu 2 Std./Monat (≈ 5–8 kleine Änderungen: Texte, Bilder, Anpassungen)",
    ],
    highlight: false,
  },
  {
    ...
    features: [
      ...
      "Inhaltliche Pflege & erweiterte Anpassungen — bis zu 3 Std./Monat (≈ 8–12 Änderungen)",
    ],
    highlight: true,
