...
const orbs = [
  { x: "12%", y: "18%", size: 420, color: "rgba(255, 255, 255,0.42)", dur: 24, delay: 0, anim: "float-orb-a", z: 80 },
  { x: "82%", y: "14%", size: 300, color: "rgba(255, 255, 255,0.34)", dur: 28, delay: 2, anim: "float-orb-b", z: 140 },
  { x: "85%", y: "72%", size: 480, color: "rgba(255, 255, 255,0.36)", dur: 32, delay: 4, anim: "float-orb-a", z: -60 },
  { x: "16%", y: "82%", size: 340, color: "rgba(255, 255, 255,0.30)", dur: 26, delay: 6, anim: "float-orb-c", z: 40 },
